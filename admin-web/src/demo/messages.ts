...
const pt = {
  ...
  // Rótulos curtos do trilho de ícones. Cada um é um trecho do nome completo
  // acima, que continua sendo o nome acessível do botão.
  railMeasure: "Medições",
  railPdf: "100 itens",
  railCapture: "Coletar",
  railHome: "Oficina",
  railHome2: "Oficina 2",
  ...
  statVehicles: "veículos",
  draftsEmpty: "Nenhum rascunho aberto.",
  deleteDraft: "Apagar rascunho",
  deleteDraftAsk: "Apagar este rascunho?",
  deleteDraftLoss: "itens respondidos serão perdidos.",
  deleteDraftLossOne: "item respondido será perdido.",
  deleteDraftNone: "Nada foi respondido ainda.",
  deleteConfirm: "Apagar",
  deleteCancel: "Manter",
  draftDeleted: "Rascunho apagado. Registros finalizados não foram tocados.",
  navPdf: "Tenken do PDF · 100 itens",
  navCapture: "Coletar dados do caminhão",
  navHome: "Minha oficina",
  navHome2: "Minha oficina 2 · com transições",
  home2Tag: "Oficina 2 · transições",
  navHome3: "Minha oficina 3 · com movimento em tudo",
  home3Tag: "Oficina 3 · movimento",
...
const ja: typeof pt = {
  ...
  railHistory: "履歴",
  statVehicles: "車両",
  draftsEmpty: "下書きはありません。",
  deleteDraft: "下書きを削除",
  deleteDraftAsk: "この下書きを削除しますか？",
  deleteDraftLoss: "項目の記録が失われます。",
  deleteDraftLossOne: "項目の記録が失われます。",
  deleteDraftNone: "まだ何も記録されていません。",
  deleteConfirm: "削除",
  deleteCancel: "残す",
  draftDeleted: "下書きを削除しました。確定済の記録はそのままです。",
  navPdf: "PDFの点検表 · 100項目",
  navCapture: "車両情報の取り込み",
  navHome: "工場画面",
  navHome2: "工場 2 · 画面遷移つき",
  home2Tag: "工場 2 · 画面遷移",
  navHome3: "工場 3 · 全体に動きつき",
  home3Tag: "工場 3 · 動き",
  navQueue: "送信待ち",
  navHistory: "履歴",
  operatorName: "見本担当者",
